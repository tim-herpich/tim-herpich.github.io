...
<p>The take-home-message of this paper is that, while the cessation of previously discovered factor premia is not conclusive, the practical constraints due to regulations and implementation suggest that a market-neutral, cost- and tax-efficient buy-and-hold portfolio remains the gold standard for any retail investor. </p>
</div>
